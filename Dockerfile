# Docker image for tftpd using the alpine template
ARG IMAGE_NAME="tftpd"
ARG PHP_SERVER="tftpd"
ARG BUILD_DATE="Sun Jul 14 04:48:06 PM EDT 2024"
...
ARG SERVICE_PORT="80"
ARG EXPOSE_PORTS="69:69/udp 69:69/tcp 80"
ARG PHP_VERSION="system"
ARG NODE_VERSION="system"
ARG NODE_MANAGER="system"

ARG IMAGE_REPO="casjaysdevdocker/tftpd"
...
ARG PACK_LIST="bash nginx tftp-hpa \
  "
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/tftpd" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/tftpd" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/tftpd" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/tftpd" \
