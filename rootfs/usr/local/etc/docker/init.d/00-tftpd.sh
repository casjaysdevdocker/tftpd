...
# root user name
root_user_name="${TFTPD_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${TFTPD_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${TFTPD_USER_NAME:-}"
# normal user password
user_pass="${TFTPD_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# command to execute
EXEC_CMD_BIN='in.tftpd'
# command arguments
EXEC_CMD_ARGS='-l -R 4096:32767 -s /data/tftpd'
...
[ -f "$CONF_DIR/env/tftpd.script.sh" ] && . "$CONF_DIR/env/tftpd.script.sh"
# Overwrite the variabes
[ -f "$CONF_DIR/env/tftpd.sh" ] && . "$CONF_DIR/env/tftpd.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
