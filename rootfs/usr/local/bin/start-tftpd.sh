...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202211121554-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  start-tftpd.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Nov 12, 2022 15:54 EST
# @@File             :  start-tftpd.sh
# @@Description      :  script to start tftpd
...
HOSTNAME="${HOSTNAME:-casjaysdev-tftpd}"
...
#SERVICE_PORT=""
SERVICE_NAME="tftpd"
SERVICE_COMMAND="/usr/sbin/in.tftpd -l ${INTFTPD_OPTS}"
